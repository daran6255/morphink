...
const InteractiveCasePreview = styled(Box)(({ theme }) => ({
  position: 'absolute',
...
const TRUST_CREDENTIALS = [
  {
    ...
    title: 'Regulatory-Grade Rigor',
    detail: 'Audits and half-yearly reports built to withstand formal scrutiny under DEPwD, WCAG 2.1, and Section 508.',
  },
  {
    icon: HandshakeOutlinedIcon,
    tone: 'accent' as const,
    title: 'Sustainable Handover',
    detail: 'Every solution is co-built and handed over with coaching so client teams own and run their systems independently.',
  },
  {
...
export const SuccessStoriesHeroSection = () => (
  <Box component="section" aria-labelledby="success-stories-hero-heading">
      ...
      <Grid container spacing={{ xs: 5, md: 6, lg: 8 }} sx={{ alignItems: 'center' }}>
        ...
        <Grid size={{ xs: 12, md: 7, lg: 6 }}>
          <Stack spacing={3.5}>
            <Chip
              icon={<PulseDot />}
              label={successStoriesHeroData.eyebrow}
              variant="outlined"
              size="medium"
              sx={(theme) => ({
            ...
            >
              {successStoriesHeroData.headline} <GradientText>{successStoriesHeroData.headlineHighlight}</GradientText>
            </Typography>
            ...
            >
              {successStoriesHeroData.subheadline}
            </Typography>
            ...
            >
              ...
              <Typography variant="caption" color="text.secondary" sx={{ lineHeight: 1.5, fontSize: '0.8125rem' }}>
                {successStoriesHeroData.disclaimer}
              </Typography>
            </Box>
            ...
            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2} sx={{ pt: 1 }}>
              <Button
                tone="primary"
                variant="contained"
                href={successStoriesHeroData.primaryCta.href}
                size="large"
              ...
              >
                {successStoriesHeroData.primaryCta.label}
              </Button>

              <Button
                variant="outlined"
                size="large"
                href={successStoriesHeroData.secondaryCta.href}
                sx={(theme) => ({
                  px: 3.5,
                  py: 1.6,
                  fontSize: '1.0625rem',
              ...
              >
                {successStoriesHeroData.secondaryCta.label}
              </Button>
            </Stack>

            {/* Key Stat Pills */}
            <Stack direction="row" spacing={1.5} sx={{ pt: 1, flexWrap: 'wrap', gap: 1.5 }}>
              {successStoriesHeroData.stats.map((stat, idx) => (
        ...
        <Grid size={{ xs: 12, md: 5, lg: 6 }}>
          <Box sx={{ position: 'relative', px: { xs: 0, sm: 2, md: 0 } }}>
            ...
            >
              ...
              >
                <TrendingUpOutlinedIcon sx={{ fontSize: 26 }} />
              </Box>
              <Box>
                <Typography variant="subtitle2" sx={{ fontWeight: 800, color: 'text.primary', lineHeight: 1.2 }}>
                  Iconic Skylines
